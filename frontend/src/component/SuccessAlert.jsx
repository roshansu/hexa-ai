export default function SuccessAlert({text, close}) {
    return (
        <div className="bg-white fixed top-10 left-10 lg:top-20 lg:left-[40%] z-20 inline-flex space-x-3 p-3 text-sm rounded border border-gray-300/60">
            ...
            <div>
                <h3 className="text-gray-700 font-medium">Successfully!</h3>
                <p className="text-gray-500">{text}</p>
            </div>
            <button onClick={()=>close('')} type="button" aria-label="close" className="inline-flex cursor-pointer active:scale-95 transition">
